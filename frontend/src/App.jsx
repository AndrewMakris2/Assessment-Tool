...
export default function App() {
  ...
  // Landing
  if (page === 'landing') {
    return <LandingPage onGetStarted={() => setPage('admin-login')} onClientPortal={() => setPage('client-login')} />;
  }

  // Admin login
  if (page === 'admin-login') {
    return <LoginPage onAuth={handleAdminAuth} onBack={() => setPage('landing')} />;
  }

  // Client login / activation
  if (page === 'client-login' || page === 'client-activate') {
    return <ClientLogin onAuth={handleClientAuth} onBack={() => setPage('landing')} inviteToken={inviteToken} />;
  }
