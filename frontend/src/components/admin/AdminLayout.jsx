const NAV = [
  ...
  { id: 'new-assessment', label: 'New Assessment', icon: 'M12 4.5v15m7.5-7.5h-15' },
];

export default function AdminLayout({ currentPage, onNavigate, username, onLogout, children }) {
  return (
      ...
      <aside className="w-56 border-r border-white/[0.06] bg-surface-1 flex flex-col fixed inset-y-0 left-0 z-20">
        ...
        <div className="px-3 py-3 border-t border-white/[0.06]">
          <div className="flex items-center justify-between">
            <span className="text-[11px] text-subtle font-mono truncate">{username}</span>
            <button onClick={onLogout} className="text-[11px] text-subtle hover:text-red-400 transition-colors">
              Sign out
            </button>
          </div>
        </div>
